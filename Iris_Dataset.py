...
df = pd.read_csv('C:/Users/mtorr/Documents/Coding-Temple/8-Module/Lessons/M8-Applied-Iris-Breast-Cancer/data/iris.csv')
...
if page == "Home":
    st.title("📊 Iris Dataset Exploter")
...
# Data Overview
    ...
    # Dataset Display
    st.subheader("Quick Glacne at the Data")
